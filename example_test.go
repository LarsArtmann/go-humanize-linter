...
// ExampleRuleWordSeries shows the H012 manual-word-series rule.
func ExampleRuleWordSeries() {
	rule := humanizelint.RuleWordSeries()

	fmt.Println(rule.Meta.ID, rule.Meta.Name)

	// Output: H012 manual-word-series
}
