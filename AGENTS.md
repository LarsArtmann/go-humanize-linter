...
H001-H010, stable identifiers for suppression matching and filter config. Exported as `RuleIDH001`-`RuleIDH010` constants in `rules.go`. `RuleIDH0SUP` is the exported pseudo-rule ID for suppression verification.
