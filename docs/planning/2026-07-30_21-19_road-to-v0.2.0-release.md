...
1–4. Above
5. **Negative testdata for H008/H009** — clean code that must NOT flag
6. **`docs/rules/H008.md` + `H009.md`** — users clicking from README find nothing today
7. **CONTRIBUTING.md fix** — correct dev commands + rule-addition checklist
8. **`TestHasOrdinalSwitch`** — test parity with every other rule
9. **White-box tests for `pattern_commaf.go` helpers** — silent-regression prevention
10. **Real-world validation sweep of H008/H009** — extend the "~0% FP" claim
